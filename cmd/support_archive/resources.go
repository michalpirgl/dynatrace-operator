...
func newK8sObjectCollector(context context.Context, log logger.DtLogger, supportArchive archiver, namespace string, appName string, apiReader client.Reader, kubeConfig rest.Config) collector { //nolint:revive // argument-limit doesn't apply to constructors
