...
func newTroubleshootCollector(context context.Context, log logr.Logger, supportArchive tarballer, namespace string, apiReader client.Reader, kubeConfig rest.Config) collector { //nolint:revive // argument-limit doesn't apply to constructors
