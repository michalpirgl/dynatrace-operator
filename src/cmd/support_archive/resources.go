...
func newK8sObjectCollector(context context.Context, log logr.Logger, supportArchive tarballer, namespace string, apiReader client.Reader) collector { //nolint:revive // argument-limit doesn't apply to constructors
