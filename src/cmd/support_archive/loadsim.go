...
func newLoadSimCollector(context context.Context, log logr.Logger, supportArchive tarballer, fileSize int, fileCount int, pods clientgocorev1.PodInterface) collector { //nolint:revive // argument-limit doesn't apply to constructors
